...
//                    newdatestr = sdfnew.format(calldate);
     ...
     * 将整个日志文件转格式存到新文档并写入数据库
     */
    public static long copytomcatlog(String readfilepath, String writefilepath) {
     ...
     * 将日志文件的最后指定行数转格式存到新文档并写入数据库
     */
    public static long copytomcatloglastline(String readfilepath, String writefilepath, long lines) throws IOException {
        long startat = System.currentTimeMillis();
